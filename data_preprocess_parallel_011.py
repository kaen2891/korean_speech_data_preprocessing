...
if __name__=="__main__":
    ...
    parser.add_argument('--start_dir_train_wav1', type=str, default='/NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/011_korean_child/01.데이터/1.Training/source_formatted')
    parser.add_argument('--start_dir_train_wav2', type=str, default='/NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/011_korean_child/01.데이터/1.Training/source_free')
    
    parser.add_argument('--start_dir_valid_wav1', type=str, default='/NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/011_korean_child/01.데이터/2.Validation/source_formatted')
    ...
    parser.add_argument('--start_dir_train_txt1', type=str, default='/NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/011_korean_child/01.데이터/1.Training/label_formatted')
    ...
    parser.add_argument('--start_dir_valid_txt1', type=str, default='/NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/011_korean_child/01.데이터/2.Validation/label_formatted')
    ...
    parser.add_argument('--dataset_name', type=str, default='011_korean_child')
