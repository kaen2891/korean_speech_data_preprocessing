...
def label_directory(path1, path2, train_or_val, added_name):
    ...
    df.to_csv(os.path.join(args.asr_save_dir, train_or_val, added_name, 'label.csv'))
    
    with open(os.path.join(args.asr_save_dir, train_or_val, added_name, 'no_paired.csv'), 'w') as f:
        for data in Parallel_NoPaired_List:
            f.write(data+'\n')
    
    with open(os.path.join(args.asr_save_dir, train_or_val, added_name, 'can_not_read.csv'), 'w') as f:
        for data in Parallel_wavReadError_List:
            f.write(data+'\n')
    
    with open(os.path.join(args.asr_save_dir, train_or_val, added_name, 'no_signal.csv'), 'w') as f:
        for data in Parallel_wavNoSignal_List:
            f.write(data+'\n')
    
    with open(os.path.join(args.asr_save_dir, train_or_val, added_name, 'stereo_channel.csv'), 'w') as f:
    ...
    with open(os.path.join(args.asr_save_dir, train_or_val, added_name, 'data_duration.txt'), 'w') as f:
...
def label_file(wavpath, jsonpath, Parallel_wavtxtDict, Parallel_NoPaired_List, Parallel_wavReadError_List, Parallel_wavNoSignal_List, Parallel_wavStereo_List, Parallel_wavDuration, Parallel_jsonProb_List, Parallel_wavShort_List):    
    ...
    _dir, txt_id = os.path.split(jsonpath) #/NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/011_korean_child/01.데이터/2.Validation/label_free/kor_free/2021-12-20/4483/, ~.json
    _dir_dir, dir = os.path.split(_dir) # /NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/011_korean_child/01.데이터/2.Validation/label_free/kor_free/2021-12-20, 4483
    _dir_dir_dir, dir_dir = os.path.split(_dir_dir) # /NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/011_korean_child/01.데이터/2.Validation/label_free/kor_free, 2021-12-20
    _dir_dir_dir_dir, dir_dir_dir = os.path.split(_dir_dir_dir) #/NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/011_korean_child/01.데이터/2.Validation/label_free, kor_free
    _dir_dir_dir_dir_dir, label_level = os.path.split(_dir_dir_dir_dir) #/NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/011_korean_child/01.데이터/2.Validation/, label_free
    
    _dir_dir_dir_dir_dir_dir, train_or_valid = os.path.split(_dir_dir_dir_dir_dir) #/NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/007_phone_recognition/01.데이터, 2.Validation
    
    asr_save_dir = os.path.join(args.asr_save_dir, train_or_valid)
    ssl_save_dir = os.path.join(args.ssl_save_dir, train_or_valid)
    
    if label_level == 'label_free':
        source_level = 'source_free'
        save_level = 'free'
    elif label_level == 'label_formatted':
        source_level = 'source_formatted'
        save_level = 'formatted'
    ...
    if error_check != 1:
        txt = json_data['Transcription']['LabelText']
        wav = os.path.join(_dir_dir_dir_dir_dir, source_level, dir_dir_dir, dir_dir, dir, txt_id.replace('.'+txt_extension, '.wav'))
    ...
    if error_check != 1:        
        ...
        if error_check != 1:
            asr_save_dir_tmp = os.path.join(asr_save_dir, save_level, dir_dir_dir, dir_dir, dir)
            if not os.path.exists(asr_save_dir_tmp):
                os.makedirs(asr_save_dir_tmp)
            
            ssl_save_dir_tmp = os.path.join(ssl_save_dir, save_level, dir_dir_dir, dir_dir, dir)
...
if __name__=="__main__":
    ...
    parser.add_argument('--start_dir_train_wav1', type=str, default='/NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/012_korean_eng_child/01.데이터/1.Training/source_formatted')
    parser.add_argument('--start_dir_train_wav2', type=str, default='/NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/012_korean_eng_child/01.데이터/1.Training/source_free')
    
    parser.add_argument('--start_dir_valid_wav1', type=str, default='/NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/012_korean_eng_child/01.데이터/2.Validation/source_formatted')
    parser.add_argument('--start_dir_valid_wav2', type=str, default='/NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/012_korean_eng_child/01.데이터/2.Validation/source_free')
    
    parser.add_argument('--start_dir_train_txt1', type=str, default='/NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/012_korean_eng_child/01.데이터/1.Training/label_formatted')
    parser.add_argument('--start_dir_train_txt2', type=str, default='/NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/012_korean_eng_child/01.데이터/1.Training/label_free')
    
    parser.add_argument('--start_dir_valid_txt1', type=str, default='/NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/012_korean_eng_child/01.데이터/2.Validation/label_formatted')
    parser.add_argument('--start_dir_valid_txt2', type=str, default='/NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/012_korean_eng_child/01.데이터/2.Validation/label_free')
    
    parser.add_argument('--dataset_name', type=str, default='012_korean_eng_child')
