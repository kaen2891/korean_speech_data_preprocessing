...
def label_file(wavpath, jsonpath, Parallel_wavtxtDict, Parallel_NoPaired_List, Parallel_wavReadError_List, Parallel_wavNoSignal_List, Parallel_wavStereo_List, Parallel_wavDuration, Parallel_jsonProb_List, Parallel_wavShort_List):    
    ...
    _dir, txt_id = os.path.split(jsonpath) #/NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/007_phone_recognition/01.데이터/1.Training/label/D02/J12/S005180/, ~.json
    _dir_dir, dir = os.path.split(_dir) # /NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/007_phone_recognition/01.데이터/1.Training/label/D02/J12/, S005180
    _dir_dir_dir, dir_dir = os.path.split(_dir_dir) # /NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/007_phone_recognition/01.데이터/1.Training/label/D02/, J12
    _dir_dir_dir_dir, dir_dir_dir = os.path.split(_dir_dir_dir) #/NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/007_phone_recognition/01.데이터/1.Training/label , D02
    _dir_dir_dir_dir_dir, label_level = os.path.split(_dir_dir_dir_dir) #/NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/007_phone_recognition/01.데이터/1.Training, label
    _dir_dir_dir_dir_dir_dir, train_or_valid = os.path.split(_dir_dir_dir_dir_dir) #/NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/007_phone_recognition/01.데이터/1.Training, label
    ...
    if error_check != 1:        
        json_crawl = json_data['dataSet']['dialogs'] #007_phone_recognition
        txt_crawl = [text["text"] for text in json_crawl]
        audiopath_crawl = [text["audioPath"] for text in json_crawl]
    
    
        for i in range(len(json_crawl)):
            wav = os.path.join(_dir_dir_dir_dir_dir, source_level, audiopath_crawl[i])
                    
            if os.path.isfile(wav) == False:
                Parallel_NoPaired_List.append(audiopath_crawl[i])
                continue
            ...
            txt = txt_crawl[i].strip()
            
            #wav, based_sr = torchaudio.load(wav)
            ...
            asr_save_dir_tmp = os.path.join(asr_save_dir, dir_dir_dir, dir_dir, dir)
            if not os.path.exists(asr_save_dir_tmp):
                os.makedirs(asr_save_dir_tmp)
            
            ssl_save_dir_tmp = os.path.join(ssl_save_dir, dir_dir_dir, dir_dir, dir)
...
if __name__=="__main__":
    ...
    parser.add_argument('--start_dir_train_wav', type=str, default='/NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/007_phone_recognition/01.데이터/1.Training/source')
    parser.add_argument('--start_dir_valid_wav', type=str, default='/NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/007_phone_recognition/01.데이터/2.Validation/source')
    parser.add_argument('--start_dir_train_txt', type=str, default='/NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/007_phone_recognition/01.데이터/1.Training/label')
    parser.add_argument('--start_dir_valid_txt', type=str, default='/NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/007_phone_recognition/01.데이터/2.Validation/label')    
    parser.add_argument('--dataset_name', type=str, default='007_phone_recognition')
