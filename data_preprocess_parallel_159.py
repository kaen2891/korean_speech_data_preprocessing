...
def label_file(wavpath, jsonpath, Parallel_wavtxtDict, Parallel_NoPaired_List, Parallel_wavReadError_List, Parallel_wavNoSignal_List, Parallel_wavStereo_List, Parallel_wavDuration, Parallel_jsonProb_List, Parallel_wavShort_List):    
    ...
    _dir, txt_id = os.path.split(jsonpath) #/NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/159_number_speech/01.데이터/2.Validation/label/03.환율-달러-외국환/144615, ~.json
    _dir_dir, dir = os.path.split(_dir) # /NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/159_number_speech/01.데이터/2.Validation/label/03.환율-달러-외국, 144615
    _dir_dir_dir, dir_dir = os.path.split(_dir_dir) # /NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/159_number_speech/01.데이터/2.Validation/label, 03.환율-달러-외국
    _dir_dir_dir_dir, label_level = os.path.split(_dir_dir_dir) #/NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/159_number_speech/01.데이터/2.Validation, label
    ...
    if error_check != 1:
        ...
        wav = os.path.join(_dir_dir_dir_dir, source_level, dir_dir, dir, txt_id.replace('.'+txt_extension, '.'+wav_extension))
    ...
    if error_check != 1:        
        ...
        if error_check != 1:
            asr_save_dir_tmp = os.path.join(asr_save_dir, dir_dir, dir)
            if not os.path.exists(asr_save_dir_tmp):
                os.makedirs(asr_save_dir_tmp)
            
            ssl_save_dir_tmp = os.path.join(ssl_save_dir, dir_dir, dir)
...
if __name__=="__main__":
    ...
    parser.add_argument('--start_dir_train_wav1', type=str, default='/NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/159_number_speech/01.데이터/1.Training/source')
    ...
    parser.add_argument('--start_dir_valid_wav1', type=str, default='/NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/159_number_speech/01.데이터/2.Validation/source')
    ...
    parser.add_argument('--start_dir_train_txt1', type=str, default='/NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/159_number_speech/01.데이터/1.Training/label')
    ...
    parser.add_argument('--start_dir_valid_txt1', type=str, default='/NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/159_number_speech/01.데이터/2.Validation/label')
    ...
    parser.add_argument('--dataset_name', type=str, default='159_number_speech')
